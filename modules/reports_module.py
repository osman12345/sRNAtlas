...
def generate_summary_section(session_state: dict) -> str:
    ...
    html = '<div class="section"><h2>📊 Analysis Summary</h2>'
...
def generate_de_section(de_results: dict) -> str:
    ...
    html = '<div class="section"><h2>🔬 Differential Expression Results</h2>'
...
def generate_enrichment_section(enrichment_results: dict) -> str:
    ...
    html = '<div class="section"><h2>🧬 Functional Enrichment</h2>'
        ...
        with st.spinner("Generating report..."):
            ...
            if report_format == "HTML":
                ...
                try:
                    ...
                    html_report = generate_html_report(report_data)
                    st.download_button(
                        "📥 Download HTML Report (PDF unavailable)",
                        html_report,
                        "analysis_report.html",
                        "text/html"
                    )
...
def render_download_data():
    ...
    # Download all as ZIP
    st.divider()
    if st.button("📥 Download All Data (ZIP)", width="stretch"):
        import zipfile
